<!--
 * @Author: GZH
 * @Date: 2022-01-04 22:06:09
 * @LastEditors: GZH
 * @LastEditTime: 2022-01-05 20:19:43
 * @FilePath: \vue3-admin-element-plus\src\views\profile\components\ProjectCard.vue
 * @Description: 项目介绍
-->
<template>
  <el-card class="user-container">
    ...
    <div class="user-profile">
      ...
      <div class="box-center">
        <pan-thumb :image="$store.getters.userInfo.avatar + '1'" height="100px" width="100px">
          <div>Hello</div>
